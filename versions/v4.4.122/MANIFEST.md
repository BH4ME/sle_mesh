...
- WS63 unified firmware version bump to `v4.4.122`.
- Behavior-preserving member runtime-match control-flow cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.122`.
...
- `versions/README.md`
- `versions/v4.4.122/VERSION.md`
- `versions/v4.4.122/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.121` records remain unchanged.
