...
- WS63 unified firmware version bump to `v4.4.104`.
- Behavior-preserving WS2812 CLI fixed-color cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.104`.
...
- `versions/README.md`
- `versions/v4.4.104/VERSION.md`
- `versions/v4.4.104/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.103` records remain unchanged.
