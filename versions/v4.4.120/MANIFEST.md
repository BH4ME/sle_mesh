...
- WS63 unified firmware version bump to `v4.4.120`.
- Behavior-preserving exact CLI pair-match cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.120`.
...
- `versions/README.md`
- `versions/v4.4.120/VERSION.md`
- `versions/v4.4.120/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.119` records remain unchanged.
