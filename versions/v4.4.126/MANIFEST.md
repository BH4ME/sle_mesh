...
- WS63 unified firmware version bump to `v4.4.126`.
- WS2812/RGB built-in brightness reduced again for default states, fixed-color commands, and test pattern.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.126`.
