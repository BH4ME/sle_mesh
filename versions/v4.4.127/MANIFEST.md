...
- WS63 unified firmware version bump to `v4.4.127`.
- WS2812/RGB built-in brightness reduced again for default states, fixed-color commands, and test pattern.
- Normal WS2812 base states now breathe for idle, leader, member, and error.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.127`.
...
- `versions/README.md`
- `versions/v4.4.127/VERSION.md`
- `versions/v4.4.127/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- Intended behavior changes are limited to dimmer built-in WS2812/RGB output and visible breathing on normal base states.
- Historical `v4.4.126` records remain unchanged.
