...
- WS63 unified firmware version bump to `v4.4.105`.
- Behavior-preserving unmuted buzzer CLI toggle cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.105`.
...
- `versions/README.md`
- `versions/v4.4.105/VERSION.md`
- `versions/v4.4.105/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.104` records remain unchanged.
