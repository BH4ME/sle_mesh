...
- WS63 unified firmware version bump to `v4.4.109`.
- Behavior-preserving serial configuration CLI return-path cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.109`.
...
- `versions/README.md`
- `versions/v4.4.109/VERSION.md`
- `versions/v4.4.109/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.108` records remain unchanged.
