...
- WS63 unified firmware version bump to `v4.4.116`.
- Behavior-preserving buzzer GPIO level-selection cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.116`.
...
- `versions/README.md`
- `versions/v4.4.116/VERSION.md`
- `versions/v4.4.116/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.115` records remain unchanged.
