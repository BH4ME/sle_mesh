...
- WS63 unified firmware version bump to `v4.4.119`.
- Behavior-preserving GPIO output initialization cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.119`.
...
- `versions/README.md`
- `versions/v4.4.119/VERSION.md`
- `versions/v4.4.119/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.118` records remain unchanged.
