...
- WS63 unified firmware version bump to `v4.4.121`.
- Behavior-preserving saved-role config apply cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.121`.
...
- `versions/README.md`
- `versions/v4.4.121/VERSION.md`
- `versions/v4.4.121/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.120` records remain unchanged.
