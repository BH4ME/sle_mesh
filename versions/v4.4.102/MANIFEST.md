...
- WS63 unified firmware version bump to `v4.4.102`.
- Behavior-preserving HTTP query parser cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.102`.
...
- `versions/README.md`
- `versions/v4.4.102/VERSION.md`
- `versions/v4.4.102/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.101` records remain unchanged.
