...
- WS63 unified firmware version bump to `v4.4.113`.
- Behavior-preserving muted buzzer CLI branch cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.113`.
...
- `versions/README.md`
- `versions/v4.4.113/VERSION.md`
- `versions/v4.4.113/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.112` records remain unchanged.
