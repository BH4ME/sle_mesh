...
- WS63 unified firmware version bump to `v4.4.111`.
- Behavior-preserving LED active-low output-level cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.111`.
...
- `versions/README.md`
- `versions/v4.4.111/VERSION.md`
- `versions/v4.4.111/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.110` records remain unchanged.
