...
- WS63 unified firmware version bump to `v4.4.118`.
- Behavior-preserving display initialization log cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.118`.
...
- `versions/README.md`
- `versions/v4.4.118/VERSION.md`
- `versions/v4.4.118/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.117` records remain unchanged.
