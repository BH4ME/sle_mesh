...
- WS63 unified firmware version bump to `v4.4.124`.
- Behavior-preserving CLI match helper return-expression cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.124`.
...
- `versions/README.md`
- `versions/v4.4.124/VERSION.md`
- `versions/v4.4.124/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.123` records remain unchanged.
