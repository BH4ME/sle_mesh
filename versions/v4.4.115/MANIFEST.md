...
- WS63 unified firmware version bump to `v4.4.115`.
- Behavior-preserving fixed-color RGB CLI branch cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.115`.
...
- `versions/README.md`
- `versions/v4.4.115/VERSION.md`
- `versions/v4.4.115/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.114` records remain unchanged.
