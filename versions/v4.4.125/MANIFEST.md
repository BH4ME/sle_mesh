...
- WS63 unified firmware version bump to `v4.4.125`.
- WS2812/RGB built-in brightness reduced for default states, fixed-color commands, and test pattern.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.125`.
...
- `versions/README.md`
- `versions/v4.4.125/VERSION.md`
- `versions/v4.4.125/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- Intended behavior change is limited to dimmer built-in WS2812/RGB output.
- Historical `v4.4.124` records remain unchanged.
