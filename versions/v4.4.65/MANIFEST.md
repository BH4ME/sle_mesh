...
- `README.md`
- `versions/README.md`
- `versions/v4.4.65/VERSION.md`
- `versions/v4.4.65/MANIFEST.md`
- `versions/v4.4.65/FLASH_AND_RELAY_TEST.md`
...
if (g_team_node.cfg.pairing_enabled != 0U) { return 1U; }
```
...
The package must contain `v4.4.65` before flashing.
