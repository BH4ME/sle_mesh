...
- WS63 unified firmware version bump to `v4.4.123`.
- Behavior-preserving HTTP query wrapper control-flow cleanup in board firmware.
- Build, flash, automation, README, and version-index defaults updated to `v4.4.123`.
...
- `versions/README.md`
- `versions/v4.4.123/VERSION.md`
- `versions/v4.4.123/MANIFEST.md`
- `xc/ws63_team_network/README.md`

## Notes

- No intentional runtime behavior change.
- Historical `v4.4.122` records remain unchanged.
