...
[![Repository](https://img.shields.io/badge/repository-v4.4.129-16a34a.svg)](versions/v4.4.129/VERSION.md)
[![Firmware](https://img.shields.io/badge/firmware-v4.4.129-2563eb.svg)](versions/v4.4.129/VERSION.md)
...
- 最新仓库记录：`v4.4.129`
- 当前固件版本：`v4.4.129`
- 最新仓库记录说明：[versions/v4.4.129/VERSION.md](versions/v4.4.129/VERSION.md)
- 当前固件记录说明：[versions/v4.4.129/VERSION.md](versions/v4.4.129/VERSION.md)
...
| --- | --- |
| `GET /api/status` | 板端状态 |
| `GET /api/power` | ADC battery voltage and TP4054 CHRG/source status |
| `GET /api/nodes` | 节点列表 |
| `GET /api/events` | 最近事件 |
