...
echo "profile:    v4.4.120 unified runtime role (v3.2 schematic pinmap + ADC battery)"
echo "sdk:        $WSL_SDK"
...
path.write_text(s)
print("configured v4.4.120 local WSL pinmap, ADC battery sampling, and team-network sample")
PY
...
print("post-build guard passed: local WSL v4.4.120")
PY
